# MCDH Third-Party License Manifest

This generated manifest records the declared licenses of locked Rust packages for the Windows release and production npm packages. Copyright remains with each upstream author. Consult the package registry and upstream repository for complete license text and source links.

Generation command: `pnpm license-report`
